...
"  - Modified to work with my custom dvorak layout
"  - B produces ذ rather than لا

loadkeymap
;	<char-0x0636>			" (1590)	- DAD
'	<char-0x0635>			" (1589)	- SAD
`	<char-0x062b>			" (1579)	- THEH
p	<char-0x0642>			" (1602)	- QAF
y	<char-0x0641>			" (1601)	- FEH
f	<char-0x063a>			" (1594)	- GHAIN
g	<char-0x0639>			" (1593)	- AIN
c	<char-0x0647>			" (1607)	- HEH
r	<char-0x062e>			" (1582)	- KHAH
l	<char-0x062d>			" (1581)	- HAH
\/	<char-0x062c>			" (1580)	- JEEM
\\	<char-0x062f>			" (1583)	- DAL
a	<char-0x0634>			" (1588)	- SHEEN
o	<char-0x0633>			" (1587)	- SEEN
e	<char-0x064a>			" (1610)	- YEH
u	<char-0x0628>			" (1576)	- BEH
i	<char-0x0644>			" (1604)	- LAM
d	<char-0x0627>			" (1575)	- ALEF
h	<char-0x062a>			" (1578)	- TEH
t	<char-0x0646>			" (1606)	- NOON
n	<char-0x0645>			" (1605)	- MEEM
s	<char-0x0643>			" (1603)	- KAF
_	<char-0x0637>			" (1591)	- TAH
:	<char-0x0626>			" (1574)	- YEH with HAMZA ABOVE
q	<char-0x0621>			" (1569)	- HAMZA
j	<char-0x0624>			" (1572)	- WAW with HAMZA ABOVE
k	<char-0x0631>			" (1585)	- REH
x	<char-0x0630>			" 		    - THAL ### MODIFIED ###
b	<char-0x0649>			" (1609)	- ALEF MAKSURA
m	<char-0x0629>			" (1577)	- TEH MARBUTA
w	<char-0x0648>			" (1608)	- WAW
v	<char-0x0632>			" (1586)	- ZAIN
...
" To be modifid to match my modified arabic layout
